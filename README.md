...
然后使用git功能把本项目同步到本地开发目录。然后在每次任务的目录中创建自己的目录。例如我本人，我的名字是李晓明,我需要在本次任务的项目 **practice01** 中创建 **李晓明** 的文件夹。然后按照任务要求在 **李晓明** 的文件夹内提交自己的任务成果。所以各位学员，你们也需要在项目中创建自己的目录和提交自己任务成果。
